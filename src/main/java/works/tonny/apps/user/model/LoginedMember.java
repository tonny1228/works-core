...
public class LoginedMember extends LoginedUser {
	 ...
	 * </p>
	 */
	public LoginedMember(User user, Member member) {
		this();
		this.user = user;
		this.member = member;
	}

	public LoginedMember(User user, List<Privilege> privileges) {
		this();
		this.user = user;
