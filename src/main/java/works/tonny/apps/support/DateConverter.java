...
public class DateConverter extends DefaultTypeConverter {
	private static final Logger logger = LogFactory.getLogger(DateConverter.class);
	...
	private Date doConvertToDate(Object value) throws ParseException {
		...
		if (value instanceof String) {
			result = DateUtils
					.parseDate((String) value, new String[] { DATE_PATTERN, DATETIME_PATTERN, MONTH_PATTERN });
