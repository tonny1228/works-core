...
<t:fragment name="_title"><s:text name="Element.edit.title"/></t:fragment>
...
<t:fragment>
	<script>
		addOnLoad(function(){
			$('#update_element_viewType').change(function(){
				showOptions($(this).children('option:selected').val()); 
		    });
			showOptions($('#update_element_viewType').children('option:selected').val());
			$('#update').validate({   
				rules:{
	...
	<s:form action="update">
		...
		<table class="table-form">
   			...
   			<tr>
   				...
   				<td><s:radio name="element.required" list="%{#_required}"/> </td>
   			</tr>
   			<tr>
