...
<t:fragment name="_title"><s:text name="JobLevel.edit.title"/></t:fragment>
<t:fragment name="_ctlbnt">
	<a onclick="$('#updateJobLevel').submit()" class="button-main button-icon-save"><s:text name="button.save"/></a>
</t:fragment>
<t:fragment>
<script>
	var validate_rules = {
...
<t:tpl menuId="__job" param="support=form">
	<s:form action="updateJobLevel" namespace="/user">
		<s:hidden name="id"/>
		<s:hidden name="jobId" value="%{#request.job.id}"/>
