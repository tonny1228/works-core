...
<t:fragment name="_ctlbnt">
	<a onclick="$('#saveTitle').submit()" class="button-main button-icon-save"><s:text name="button.save"/></a>
</t:fragment>
<t:fragment>
<script>
var validate_rules={
	'title.id' : {required:false,rangelength:[0,32]}
	...
	<s:form action="saveTitle">
		<table class="table-form">
	   		...
	   		<tr>
	   				...
	   				<td>
					<s:textfield name="title.orderNo" value="0"/>
   					</td>
   			</tr>
