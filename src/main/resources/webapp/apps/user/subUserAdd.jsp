...
<t:fragment name="_ctlbnt">
	<a onclick="$('#saveSubUser').submit()" class="button-main button-icon-save">保存</a>
</t:fragment>
<%@ include file="user_include.jsp" %>
<t:fragment name="_title">添加子用户</t:fragment>
<t:fragment>
...
var validate_rules={
		...
		'user.password':{required:true,rangelength:[1,20],equalTo:'#saveSubUser_confirm'},
		'confirm':{required:true,rangelength:[1,20],equalTo:'#saveSubUser_user_password'},
