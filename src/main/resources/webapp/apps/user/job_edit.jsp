...
<t:fragment name="_title"><s:text name="Job.edit.title"/></t:fragment>
<t:fragment name="_ctlbnt">
	<a onclick="$('#updateJob').submit()" class="button-main button-icon-save"><s:text name="button.save"/></a>
</t:fragment>
<t:fragment>
<script>
	var validate_rules = {
			'job.id' : {required:true,rangelength:[0,50]}
